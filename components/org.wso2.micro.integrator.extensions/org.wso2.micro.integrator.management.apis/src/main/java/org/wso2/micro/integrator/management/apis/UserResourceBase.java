...
public class UserResourceBase {
    ...
    protected JSONObject handleGet(MessageContext messageContext, Boolean isEncoded) throws UserStoreException, ResourceNotFoundException {
    ...
    private String getUserFromPathParam(MessageContext messageContext, String domain, Boolean isEncoded) throws UserStoreException,
